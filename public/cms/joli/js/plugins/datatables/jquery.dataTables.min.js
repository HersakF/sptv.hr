...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Prvi",sLast:"Zadnji",sNext:"Sljedeći",sPrevious:"Prethodni"},
sEmptyTable:"No data available in table",sInfo:"Prikazano _START_ do _END_ od ukupno _TOTAL_ zapisa",sInfoEmpty:"Prikazano 0 do 0 od ukupno 0 zapisa",sInfoFiltered:"(filtrirano _MAX_ zapisa)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Prikaži _MENU_ zapisa",sLoadingRecords:"Učitavanje...",sProcessing:"Obrađivanje...",sSearch:"Pretraga:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nisu pronađeni traženi zapisi."},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",

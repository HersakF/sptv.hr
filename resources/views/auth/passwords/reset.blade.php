...
<head>
    <title>Fleo. CMS - Obnovite lozinku</title>
...
<div class="login-container ">
    <div class="login-box animated fadeInDown">
        ...
        <div class="login-body">
            <div class="row">
                <div class="login-title text-center push-up-10"><strong>Obnovite lozinku</strong></div>
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('password.request') }}">
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Potvrdi lozinku:"required>

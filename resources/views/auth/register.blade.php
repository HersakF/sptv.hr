...
<head>
    <title>Fleo. CMS - Registracija</title>
...
<div class="login-container ">
    <div class="login-box animated fadeInDown">
        ...
        <div class="login-body">
            <div class="row">
                <div class="login-title text-center push-up-10"><strong>Registracija</strong></div>
                <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-12">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Potvrda lozinke" required>
                        </div>

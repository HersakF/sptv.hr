<div class="panel panel-colorful">
    ...
    <div class="panel-body">
        <a data-toggle="modal" data-target="#addItem" class="btn btn-lg btn-warning"><span class="fa fa-plus white"></span> Slide</a>
    </div>

    @if($items->carousels_fragments->count() > 0)
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                @foreach($items->carousels_fragments as $item)
                    <tr id="cafr_{{ $item->id }}">
                        <td class="col-sm-1">
                            <div class="img-box">

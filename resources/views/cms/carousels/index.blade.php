...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-content-wrap">
            <div class="row">
                <div class="col-md-12">
                    @include('cms/carousels/base/partials/standard')
                </div>
            </div>
        </div>
    ...
    <!-- ADD ITEM MODAL -->
    @include('cms/carousels/base/modals/add')
    @include('cms/carousels/base/modals/edit')
@endsection
...
@section('page_js')
    ...
    @include('cms/carousels/base/javascript/standard')
    @include('cms/carousels/base/javascript/delete')
    @include('cms/carousels/base/javascript/edit')
@endsection
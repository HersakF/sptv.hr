<div class="panel panel-colorful">
    ...
    <div class="panel-body">
        <a data-toggle="modal" data-target="#addItem" class="btn btn-lg btn-warning"><span class="fa fa-plus white"></span> Carousel</a>
    </div>
    @if($items->count() > 0)
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                @foreach($items as $item)
                    <tr>
                        ...
                        <td class="col-sm-1">
                            <a href="/cms/carousels/{{ $item->id }}/edit" class="btn btn-block btn-lg btn-warning">Slides</a>
                        </td>
                        <td class="col-sm-1">

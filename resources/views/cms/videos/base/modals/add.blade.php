    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">New video</h4>
            </div>
            <form class="form-horizontal push-up-10" action="/cms/videos" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label>URL</label>
                            <input type="text" name="standard_url" class="form-control" maxlength="255" placeholder="URL" oninvalid="this.setCustomValidity('Please fill in the field.')" oninput="setCustomValidity('')" required/>
                        </div>
                    </div>
                </div>

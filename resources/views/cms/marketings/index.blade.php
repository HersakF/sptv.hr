...
@section('content')
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="{{ url('cms/marketings') }}">Marketings</a></li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap">
            <div class="row">
                <div class="col-md-12">
                    @include('cms/marketings/base/partials/standard')
                </div>
            </div>
        </div>
    ...
    <!-- ADD MODALS -->
    @include('cms/marketings/base/modals/add')
    @include('cms/marketings/base/modals/edit')
    @include('cms/marketings/base/modals/editPhoto')
@endsection
...
@section('page_js')
    ...
    @include('cms/marketings/base/javascript/standard')
    @include('cms/marketings/base/javascript/delete')
    @include('cms/marketings/base/javascript/edit')
    @include('cms/marketings/base/javascript/sort')
@endsection
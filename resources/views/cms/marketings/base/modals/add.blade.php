    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">New advert</h4>
            </div>
            <form class="form-horizontal push-up-10" action="/cms/marketings" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label>Photo</label>
                            <input type="file" name="photos" class="files" accept="image/*" title="Search..."/>
                        </div>
                    </div>
                </div>

...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-content-wrap">
            <div class="row">
                <div class="col-md-12">
                    @include('cms/galleries/base/partials/standard')
                </div>
            </div>
        </div>
    ...
    <!-- ADD ITEM MODAL -->
    @include('cms/galleries/base/modals/add')
    @include('cms/galleries/base/modals/edit')
@endsection
...
@section('page_js')
    ...
    @include('cms/galleries/base/javascript/standard')
    @include('cms/galleries/base/javascript/delete')
    @include('cms/galleries/base/javascript/edit')
@endsection
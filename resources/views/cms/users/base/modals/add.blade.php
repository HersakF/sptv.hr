<div class="modal" id="addItemModal" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="display: none;">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal push-up-10" action="/cms/users" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label>E-mail</label>
                            <input type="email" name="email" class="form-control" maxlength="255" placeholder="E-mail" oninvalid="this.setCustomValidity('Please fill in the field.')" oninput="setCustomValidity('')" required/>
                        </div>
                        <div class="col-md-12">
                            <label>Password</label>
                            <input type="password" name="password" class="form-control" maxlength="255" placeholder="Password" oninvalid="this.setCustomValidity('Please fill in the field.')" oninput="setCustomValidity('')" required/>
                        </div>
                        <div class="col-md-12">

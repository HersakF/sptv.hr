    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">New file</h4>
            </div>

            <div class="newPhoto">
                <form class="form-horizontal" action="/cms/files" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <label>Files</label>
                                <input type="file" multiple name="files[]" class="files" title="Search..." accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" oninvalid="this.setCustomValidity('Please fill in the field.')" oninput="setCustomValidity('')" required/>
                            </div>
                        </div>
                    </div>

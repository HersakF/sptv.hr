<div class="modal" id="editCarouselsItemModal" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal push-up-10" id="editCarouselsItemForm" action="" method="POST" enctype="multipart/form-data">

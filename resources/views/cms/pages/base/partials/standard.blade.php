            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        @if($user->role == 'superadministrator')<th>Removable</th>@endif
                ...
                <tbody id="sortablePages" style="overflow:auto;">
                @foreach($items as $item)
                    <tr id="page_{{ $item->id }}">
                        ...
                        <td class="col-sm-1">
                            <select class="form-control select set-navigation" id="{{ $item->id }}" value="{{ $item->navigation }}">

...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-content-wrap">
            <div class="row">
                <div class="col-md-12">
                    @include('cms/pages/base/partials/standard')
                </div>
            </div>
        </div>
    ...
    <!-- ADD ITEM MODAL -->
    @include('cms/pages/base/modals/add')
...
@section('page_js')
    ...
    @include('cms/pages/base/javascript/standard')
    @include('cms/pages/base/javascript/sortable')
    @include('cms/pages/base/javascript/delete')
